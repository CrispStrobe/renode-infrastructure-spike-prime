...
namespace Antmicro.Renode.PeripheralsTests
{
    ...
    public class STM32F7I2CTests
    {
        ...
        public void SetUp()
        {
            ...
            target = new RecordingI2CPeripheral();
        ...
        public void ShouldGateTransmitRequestsWithDMAEnable()
        {
            ...
            CollectionAssert.AreEqual(new byte[] { 0x00, 0x40 }, target.WrittenBytes);
        }

        [Test]
        public void ShouldRequestEveryByteOfDMARead()
        {
            target.ReadBytes.Enqueue(0x40);
        ...
        private RecordingI2CPeripheral target;
        ...
        private sealed class RecordingI2CPeripheral : II2CPeripheral
        {
            ...
            public byte[] Read(int count = 1)
            {
                ...
                {
                    result[i] = ReadBytes.Count > 0 ? ReadBytes.Dequeue() : (byte)0;
                }
                return result;
            }
            ...
            public Queue<byte> ReadBytes { get; } = new Queue<byte>();
        }
